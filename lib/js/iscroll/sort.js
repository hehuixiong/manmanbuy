...
function swpie() {
    ...
    console.log(menu_ul.offsetWidth);

    var maxDis = -(menu_ul.offsetWidth - (document.body.offsetWidth - 20));
    // console.log(maxDis);
    window.onresize = function() {
        maxDis = -(menu_ul.offsetWidth - (document.body.offsetWidth - 20));
    }
